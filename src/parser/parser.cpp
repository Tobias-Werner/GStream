...
#line 2 "../include/parser/parser.y"
...
#line 37 "../include/parser/parser.c"
...
#endif
#define ParseARG_SDECL STREAM::Manager* manager;
#define ParseARG_PDECL ,STREAM::Manager* manager
#define ParseARG_PARAM ,manager
#define ParseARG_FETCH STREAM::Manager* manager=yypParser->manager;
#define ParseARG_STORE yypParser->manager=manager;
...
static const char *const yyTokenName[] = { 
  ...
  /*   11 */ "K_SELECT",
  /*   12 */ "K_FROM",
  /*   13 */ "K_OPEN_SQUARE_BRACKET",
  /*   14 */ "K_SLIDE",
  /*   15 */ "V_LONG",
  /*   16 */ "K_MS",
  /*   17 */ "K_CLOSE_SQUARE_BRACKET",
  /*   18 */ "K_TILT",
  /*   19 */ "V_DOUBLE",
  /*   20 */ "K_M",
  /*   21 */ "K_WAY",
...
static const char *const yyRuleName[] = {
 /*   0 */ "creation ::= K_CREATE K_STREAM IDENTIFIER K_OPEN_BRACKET attributeList K_CLOSE_BRACKET",
 /*   1 */ "creation ::= viewCreationClause selectionClause fromClause window",
 /*   2 */ "creation ::= viewCreationClause selectionClause fromClause K_JOIN identifierList K_ON conditionList window",
 /*   3 */ "viewCreationClause ::= K_CREATE K_VIEW IDENTIFIER K_AS",
 /*   4 */ "selectionClause ::= K_SELECT attributeList",
 /*   5 */ "selectionClause ::= K_SELECT aggregation",
 /*   6 */ "fromClause ::= K_FROM IDENTIFIER",
 /*   7 */ "window ::= K_OPEN_SQUARE_BRACKET K_SLIDE V_LONG K_MS K_CLOSE_SQUARE_BRACKET",
 /*   8 */ "window ::= K_OPEN_SQUARE_BRACKET K_TILT V_LONG K_MS K_CLOSE_SQUARE_BRACKET",
 /*   9 */ "window ::= K_OPEN_SQUARE_BRACKET K_SLIDE V_DOUBLE K_M K_ON IDENTIFIER K_CLOSE_SQUARE_BRACKET",
 /*  10 */ "window ::= K_OPEN_SQUARE_BRACKET K_TILT V_DOUBLE K_M K_ON IDENTIFIER K_CLOSE_SQUARE_BRACKET",
...
static const signed char yyRuleInfoNRhs[] = {
   -6,  /* (0) creation ::= K_CREATE K_STREAM IDENTIFIER K_OPEN_BRACKET attributeList K_CLOSE_BRACKET */
   -4,  /* (1) creation ::= viewCreationClause selectionClause fromClause window */
   -8,  /* (2) creation ::= viewCreationClause selectionClause fromClause K_JOIN identifierList K_ON conditionList window */
   -4,  /* (3) viewCreationClause ::= K_CREATE K_VIEW IDENTIFIER K_AS */
   -2,  /* (4) selectionClause ::= K_SELECT attributeList */
   -2,  /* (5) selectionClause ::= K_SELECT aggregation */
   -2,  /* (6) fromClause ::= K_FROM IDENTIFIER */
   -5,  /* (7) window ::= K_OPEN_SQUARE_BRACKET K_SLIDE V_LONG K_MS K_CLOSE_SQUARE_BRACKET */
   -5,  /* (8) window ::= K_OPEN_SQUARE_BRACKET K_TILT V_LONG K_MS K_CLOSE_SQUARE_BRACKET */
   -7,  /* (9) window ::= K_OPEN_SQUARE_BRACKET K_SLIDE V_DOUBLE K_M K_ON IDENTIFIER K_CLOSE_SQUARE_BRACKET */
   -7,  /* (10) window ::= K_OPEN_SQUARE_BRACKET K_TILT V_DOUBLE K_M K_ON IDENTIFIER K_CLOSE_SQUARE_BRACKET */
...
/********** Begin reduce actions **********************************************/
      ...
      case 0: /* creation ::= K_CREATE K_STREAM IDENTIFIER K_OPEN_BRACKET attributeList K_CLOSE_BRACKET */
#line 62 "../include/parser/parser.y"
{
    for(auto& a : *yymsp[-1].minor.yy8)
        a.setSrc(*(yymsp[-3].minor.yy0->stringValue));
