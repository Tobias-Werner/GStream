...
//remove("~/testdb.sqlite");
    ...
    SECTION("Create spatial stream") {
        ...
        exec("INSERT INTO s(the_geom) VALUES(geomFromWKT('LINESTRING(8.205981673199906 53.10468771859567 125.25, 8.2133843340883903 53.11456976365428062 124.01, 8.21827274164293797 53.11261177245636134 122.35)', 6, 2));");
