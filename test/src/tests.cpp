...
//remove("~/testdb.sqlite");
    ...
    SECTION("Create spatial stream") {
        ...
        exec("INSERT INTO s(the_geom) VALUES(geomFromWKT('MULTILINESTRING((8.205982 53.104688 125.25, 8.213384 53.114570 124.01, 8.218273 53.112612 122.35, 8.205982 53.104688 125.25), (8.205982 53.104688 125.25, 8.213384 53.114570 124.01, 8.218273 53.112612 122.35, 8.205982 53.104688 125.25))', 6, 2));");
